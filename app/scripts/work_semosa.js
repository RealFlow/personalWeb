...
DG.Work.SEMOSA = {
	...
	setHeader: function(){
		...
		var html = 	'<div id="workwrap" class="workwrap-semosa">'+
					'<div class="container">'+
					'<div class="row">'+
					'<div class="col-lg-6 col-lg-offset-3">'+
					'<h1>SEMOSA</h1>'+
					'<h4>(Single European Mobile Services Area)</h4>'+
	...
	initContentGallery: function() {
		...
		var html =  '<div class="row centered mb">'+
					...
					'<h4>GALLERY</h4>'+
					'<img class="img-responsive img-thumbnail" src="images/portfolio_content/work_semosa_1.png">'+
					'<br>'+
					''+
					'<div id="gallery-title-1" style="display:none">'+
					'<div class="custom-html">'+
					'<h4 style="color: white">Android Mobile Application</h4>'+
					'</div>'+
					'</div>'+
					''+
					'<ul id="light-gallery" class="gallery centered">'+
					'<li data-src="images/portfolio_content/work_semosa_1.png"'+
					'data-sub-html="#gallery-title-1">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_1_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'<li data-src="images/portfolio_content/work_semosa_2.png"'+
					'data-sub-html="#gallery-title-1">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_2_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'<li data-src="images/portfolio_content/work_semosa_3.png"'+
					'data-sub-html="#gallery-title-1">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_3_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'<li data-src="images/portfolio_content/work_semosa_4.png"'+
					'data-sub-html="#gallery-title-1">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_4_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'<li data-src="images/portfolio_content/work_semosa_5.png"'+
					'data-sub-html="#gallery-title-2">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_5_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'<li data-src="images/portfolio_content/work_semosa_6.png"'+
					'data-sub-html="#gallery-title-2">'+
					'<a href="#">'+
					'<img src="images/portfolio_content/work_semosa_6_thumb.jpg" />'+
					'</a>'+
					'</li>'+
					'</ul>'+
					'</div>'+
